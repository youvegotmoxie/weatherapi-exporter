...
curTemp = Gauge("current_temperature", "Current temperature in F",
                labelnames=prometheus_labels)
curWindSpeed = Gauge("current_wind_speed",
                     "Current wind speed in MPH", labelnames=prometheus_labels)
curWindDir = Gauge("current_wind_direction",
                   "Current wind direction in degrees", labelnames=prometheus_labels)
curPrecip = Gauge("current_precipitation",
                  "Current precipitation levels in inches", labelnames=prometheus_labels)
curHumid = Gauge("current_humidity", "Current humidity level",
                 labelnames=prometheus_labels)
curUV = Gauge("current_uv_index", "Current UV index",
              labelnames=prometheus_labels)
curCloud = Gauge("current_cloud_cover",
                 "Current Level of cloud cover", labelnames=prometheus_labels)
curPressure = Gauge("current_baro_pressure",
                    "Current barometric pressure", labelnames=prometheus_labels)
